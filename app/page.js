...
export default function Home() {
  ...
  return (
    <div className='flex flex-col gap-16 justify-center items-center h-screen'>
      ...
      <section className="flex flex-col gap-6 bg-[#292829] py-8 px-4 rounded-xl w-[95%] 
       max-w-4xl mx-auto"
      >
        <div className="flex flex-col gap-3">
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-center text-purple-700">
            Minha Fuinha
          </h1>

          <h1 className="text-base sm:text-lg lg:text-2xl text-center text-gray-200">
            Me fazendo o cara mais feliz do mundo há:
          </h1>
        </div>

        <div className="flex justify-center gap-4 sm:gap-6 lg:gap-10 flex-wrap">
